...
# # ssm creation
# data "aws_iam_policy_document" "sss-assume-role" {
#   statement {
#     effect = "Allow"
...
#   name               = "vault-ssm-role"
#   assume_role_policy = data.aws_iam_policy_document.sss-assume-role.json
# }
...
#   depends_on         = [aws_iam_role_policy_attachment.ssm-role-attach]
# }
